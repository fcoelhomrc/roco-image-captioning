...
############# TEMPLATE #############
# id | name (image path) | caption #
#                                  #
####################################

def create_jsons(train_path, validation_path, test_path, jsonpath):
    # read data
    train_df = pd.read_csv(os.path.join(train_path, "radiology", "train.csv"))
    validation_df = pd.read_csv(os.path.join(validation_path, "radiology", "validation.csv"))
    test_df = pd.read_csv(os.path.join(test_path, "radiology", "test.csv"))
...
if __name__ == "__main__":
    create_jsons(
        "/home/felipe/Projects/roco-image-captioning/roco-dataset/data/train",
    "/home/felipe/Projects/roco-image-captioning/roco-dataset/data/validation",
        "/home/felipe/Projects/roco-image-captioning/roco-dataset/data/test",
        "/home/felipe/Projects/roco-image-captioning/roco-dataset/json"
    )